...
1. 浏览器 Chorme V8解析引擎 内置API
![](./2023-03-17-14-43-43.png)
2. Node V8解析引擎 内置API
![](./2023-03-17-14-42-07.png)
3. Node中没有DOM BOM AJAX 等
4. Node中是 global 和 globalThis(ES2020) 指代 window
5. Node 中有 fs path http 
...
- 行、头、体
- 响应行：
![](./2023-03-18-14-40-18.png)
![](./2023-03-18-14-42-46.png)
- **IP**
- 子网掩码划分网络号和主机号
- 私有IP地址段：(局域网 可相同)  NAT的技术
